...
define('DOMAIN_URL', 'https://lotteryuser.greymatterworks.in/'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
...
class Database
{
    ...
    private $db_user = "u743445510_lottery";  // Change as required
    private $db_pass = "Lottery@2022";  // Change as required
    private $db_name = "u743445510_lottery";    // Change as required
