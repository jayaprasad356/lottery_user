...
define('DOMAIN_URL', 'https://localhost/lottery_user/'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
...
class Database
{
    ...
    private $db_name = "lottery";    // Change as required
