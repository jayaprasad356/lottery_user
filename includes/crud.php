...
define('DOMAIN_URL', 'http://andamanlottery.com'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
...
class Database
{
    ...
    private $db_user = "uu424887645_and";  // Change as required
    private $db_pass = "And@0111";  // Change as required
    private $db_name = "uu424887645_and";    // Change as required
